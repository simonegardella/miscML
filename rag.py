# Retrieval Augmented Geneation

# Utente -> Query -> Ricerca -> Documenti Rilevanti -> Modello Generativo -> Utente
...
generatoreGPT = pipeline ('text-generation','meta-llama/Llama-3.2-1B')
vettori = []
...
while True:
    ...
    print (risultati)
    contesto = " ".join ([risultato.payload['testo'] for risultato in risultati])
    input_string = "Contesto:{} \n Domanda: {}".format(contesto,query)
    
    risposta = generatoreGPT (input_string,max_length=200)
    print (risposta[0]['generated_text'])
